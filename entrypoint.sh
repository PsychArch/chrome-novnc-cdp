...
export SCREEN_WIDTH SCREEN_HEIGHT SCREEN_DEPTH SERVICE_BIND_HOST TZ PROFILE_MODE CHROME_PROFILE_DIR CHROME_EXTRA_ARGS START_URL CHROME_USER_DATA_DIR ALLOW_HOST_GATEWAY
